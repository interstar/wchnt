...
Yes. `lein live` runs `wchnt-lang.prepare-live` (copy examples + seed pages), then cljsbuild (`:source-paths ["src" "live/src"]`) writes `live/public/js/main.js`. Open `live/public/index.html`. No JAR, no copy of the compiler, no Node.
